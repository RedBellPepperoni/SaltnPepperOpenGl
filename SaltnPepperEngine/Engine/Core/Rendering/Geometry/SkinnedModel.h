...
namespace SaltnPepperEngine
{
	...
	public:
		...
		vector<SharedPtr<SkinnedMesh>>    meshes;
		string directory;
		...
		SkinnedModel(string const& path, bool gamma = false) : gammaCorrection(gamma)
		{
			loadModel(path);
		}
	...
	private:
		...
		SharedPtr<SkinnedMesh> processMesh(aiMesh* mesh, const aiScene* scene)
		{
			...
			return MakeShared<SkinnedMesh>(vertices, indices);
		}
